...
export default function Footer() {
  ...
  return (
    <footer className="bg-brand-gray-950 text-brand-gray-300 pt-16 pb-8 border-t border-brand-gray-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 mb-12">
          ...
          <div className="md:col-span-5 space-y-4">
            <a href="#home" className="flex items-center gap-2 group">
              <div className="w-9 h-9 rounded-lg bg-brand-green flex items-center justify-center font-display text-brand-gray-900 font-extrabold text-lg">
                FP
              </div>
            ...
            <p className="text-xs text-brand-gray-300 leading-relaxed font-light max-w-sm">
            ...
            <div className="flex items-center space-x-3 text-brand-gray-300 pt-2">
          ...
          <div className="md:col-span-3 space-y-4">
            ...
            <ul className="space-y-2 text-xs">
              ...
              <li>
                <a href="#avaliacao" className="hover:text-brand-green transition-colors font-light">Avaliação de Saúde Grátis</a>
              </li>
              <li>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <div className="space-y-3.5 pt-1">
              <div className="flex gap-2.5 items-center">
                <div className="w-6 h-6 rounded bg-brand-gray-800 flex items-center justify-center shrink-0">
                  <Flame className="w-3.5 h-3.5 text-brand-green" />
                </div>
                <span className="text-xs font-light">Otimização Metabólica Lipídica</span>
              </div>
              <div className="flex gap-2.5 items-center">
                <div className="w-6 h-6 rounded bg-brand-gray-800 flex items-center justify-center shrink-0">
                  <Activity className="w-3.5 h-3.5 text-brand-green" />
                </div>
                <span className="text-xs font-light">Gasto Energético & Fisiologia Cardíaca</span>
              </div>
              <div className="flex gap-2.5 items-center">
                <div className="w-6 h-6 rounded bg-brand-gray-800 flex items-center justify-center shrink-0">
                  <HeartPulse className="w-3.5 h-3.5 text-brand-green" />
                </div>
                <span className="text-xs font-light">Nutrição Funcional Atleta & Longevidade</span>
              </div>
            </div>
          </div>
        ...
        <div className="pt-8 mt-8 border-t border-brand-gray-800 space-y-4 text-[11px] text-brand-gray-600 leading-relaxed font-light">
          <p>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-[10px] text-brand-gray-600 pt-2 border-t border-brand-gray-900">
            <div>
              &copy; {currentYear} Dr. Fábio Pizzini. Todos os direitos reservados. CRM-SP | RQE 130.636
            </div>
            <div>
              Atendimento presencial em Sorocaba - SP | Cliníca Integrada
            </div>
          </div>
        </div>
